...
namespace ServiceRest_20190140120_MuhammadAlvito
{
    ...
    // You can add XSD files into the project. After building the project, you can directly use the data types defined there, with the namespace "ServiceRest_20190140120_MuhammadAlvito.ContractType".
    [DataContract]
    ...
    {
        private string _nama, _nim, _prodi, _angkatan; //_ adalah Konversi atau Kesepakatan //variabel lokal
