...
namespace ServiceRest_20190140120_MuhammadAlvito
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=LAPTOP-Y700;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=123");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=LAPTOP-Y700;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=123");
